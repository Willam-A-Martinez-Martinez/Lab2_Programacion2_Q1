...
public class Empresa {
    ...
    for (Empleado e : empleados) {
        if (e.getCodigo() == codigo && e instanceof EmpleadoTemporal) {
            ...
            JOptionPane.showMessageDialog(null, "Fecha actualizada para el empleado " + codigo);
            return;
        }
    }
    JOptionPane.showMessageDialog(null, "No se encontró un empleado temporal con ese código.");
}
 ...
 public void generarReporteEmpleados() {
    ...
    for (Empleado e : empleados) {
        ...
        reporte.append(e.mostrarInformacion()).append("\n");
    }

    reporte.append("\nResumen:\n")
           .append("Estandar: ").append(estandar).append("\n")
           .append("Temporales: ").append(temporal).append("\n")
